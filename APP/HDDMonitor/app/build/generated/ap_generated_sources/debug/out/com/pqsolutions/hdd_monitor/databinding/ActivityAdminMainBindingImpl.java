...
public class ActivityAdminMainBindingImpl extends ActivityAdminMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.clientsLabel, 4);
        sViewsWithIds.put(R.id.clientRecyclerView, 5);
        sViewsWithIds.put(R.id.bottomNavigation, 6);
    }
    // views
    @NonNull
