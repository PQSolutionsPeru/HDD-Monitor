...
public final class ItemReportBinding implements ViewBinding {
  ...
  private ItemReportBinding(@NonNull ConstraintLayout rootView, @NonNull TextView dateTimeTextView,
      @NonNull TextView descriptionTextView, @NonNull TextView detailsTextView,
  ...
  public static ItemReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReportBinding((ConstraintLayout) rootView, dateTimeTextView,
          descriptionTextView, detailsTextView, statusTextView);
    }
