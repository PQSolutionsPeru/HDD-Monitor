...
private fun RelayStatusChip(
    ...
    val (backgroundColor, textColor) = when (status) {
        "OK" -> HddGreen to MaterialTheme.colorScheme.surface
        "WARNING" -> HddYellow to MaterialTheme.colorScheme.onSurface
        else -> HddRed to MaterialTheme.colorScheme.surface
    }
